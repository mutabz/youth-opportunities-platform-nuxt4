...
<div class="row mt-4">
  ...
  <section class="col-lg-6 sidebar transparent sticky-top">
      ...
      <table class="table table-hover table-bordered">
        ...
        <tbody>
          ...
          <tr v-for="user in filteredUsers" :key="user.id">
            ...
            <td>{{ user.email }}</td>
            <td>
              <span v-if="user.is_verified" class="badge bg-success" >Verified</span>
              <span v-else class="badge bg-warning text-dark" >Not Verified</span>
            </td>
            <td>
              <button class="btn btn-act text-warning me-2" @click="editUser(user)" ><Icon name="fa6-solid:pencil"/></button>
    ...
    <div
      v-if="deleteId"
      class="modal fade show d-flex justify-content-between align-items-center"
      style="background: rgba(0,0,0,0.5)"
    >
