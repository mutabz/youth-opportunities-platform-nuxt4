...
const fetchOpportunities = async () => {
  ...
  opportunities.value = dataStore.items.opportunities.filter(opp => opp.details.slugs.includes(slug))
}
          ...
          <div class="card" v-for="opp in opportunities" key="opp.id">
            ...
            <div class="card-content">
              ...
              <div class="card-footer">
                ...
                <NuxtLink :to="'/opportunities/' + item.category + '-data/' + item.id" class="btn btn-outline-primary rounded-4" style="font-size: 0.8rem; padding: 0.4rem 1rem;">View Details</NuxtLink>
              </div>
            </div>
          </div>
        </div>
